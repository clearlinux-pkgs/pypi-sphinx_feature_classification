...
%prep
%setup -q -n sphinx-feature-classification-1.0.0
cd %{_builddir}/sphinx-feature-classification-1.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583697757
...
cp %{_builddir}/sphinx-feature-classification-1.0.0/LICENSE %{buildroot}/usr/share/package-licenses/sphinx-feature-classification/294b43b2cec9919063be1a3b49e8722648424779
